...
let isOnAC: boolean = true
let settings: PowerSettings = { preventSleepOnAC: false, preventSleepOnBattery: false }
...
function loadPowerSettings(): PowerSettings {
  ...
  return { preventSleepOnAC: false, preventSleepOnBattery: false }
}
